...
extern class LibVLC
{
	...
	static function media_get_duration(p_md:cpp.RawPointer<LibVLC_Media_T>):Int;
	...
	static function media_player_get_time(p_mi:cpp.RawPointer<LibVLC_MediaPlayer_T>):Int;

	@:native('libvlc_media_player_set_time')
	static function media_player_set_time(p_mi:cpp.RawPointer<LibVLC_MediaPlayer_T>, i_time:Int):Int;
	...
	static function media_player_get_length(p_mi:cpp.RawPointer<LibVLC_MediaPlayer_T>):Int;
	...
	static function audio_get_delay(p_mi:cpp.RawPointer<LibVLC_MediaPlayer_T>):Int;

	@:native('libvlc_audio_set_delay')
	static function audio_set_delay(p_mi:cpp.RawPointer<LibVLC_MediaPlayer_T>, i_delay:Int):Int;
