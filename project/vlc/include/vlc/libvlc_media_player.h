...
{
    int i_duration; /**< duration in milliseconds */
...
{
    int i_time_offset; /**< time-offset of the chapter in milliseconds */
    int i_duration; /**< duration of the chapter in milliseconds */
 ...
 * application.
 */
LIBVLC_API void libvlc_media_player_set_xwindow(libvlc_media_player_t *p_mi, unsigned int drawable);
 ...
 */
typedef void (*libvlc_audio_pause_cb)(void *data, int pts);
 ...
 */
typedef void (*libvlc_audio_resume_cb)(void *data, int pts);
 ...
 * \param data data pointer as passed to libvlc_audio_set_callbacks() [IN]
 */
typedef void (*libvlc_audio_flush_cb)(void *data, int pts);
 ...
 * \version LibVLC 2.0.0 or later
 */
LIBVLC_API int libvlc_video_get_spu_delay( libvlc_media_player_t *p_mi );
 ...
 * \version LibVLC 2.0.0 or later
 */
LIBVLC_API int libvlc_video_set_spu_delay( libvlc_media_player_t *p_mi, int i_delay );
 ...
 * \version LibVLC 1.1.1 or later
 */
LIBVLC_API int libvlc_audio_get_delay( libvlc_media_player_t *p_mi );
 ...
 * \version LibVLC 1.1.1 or later
 */
LIBVLC_API int libvlc_audio_set_delay( libvlc_media_player_t *p_mi, int i_delay );
